...
const projectId = 'XXXXXXXXXXXXXXXXXXXXX';   //(Step 3. Place the project id from your infura project)
const projectSecret = 'XXXXXXXXXXXXXXXXXXXXXX';  //(Step 4. Place the project_secrect from your infura project)
